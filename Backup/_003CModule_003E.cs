...
internal class \u003CModule\u003E
{
  ...
  internal static unsafe void AddLog(char* value) => Logger.AddLog(new string(value));

  internal static unsafe void AddLog(char* field, char* value)
  {
    Logger.AddLog(new string(field), new string(value));
  }
...
label_4:
    ...
    defaultAppdomain = __calli((__FnPtr<int (IntPtr, IUnknown**)>) *(long*) (*(long*) icorRuntimeHostPtr1 + 104L))((IUnknown**) icorRuntimeHostPtr1, (IntPtr) ppUnk);
    ICorRuntimeHost* icorRuntimeHostPtr2 = icorRuntimeHostPtr1;
    // ISSUE: cast to a function pointer type
    // ISSUE: function pointer call
    int num = (int) __calli((__FnPtr<uint (IntPtr)>) *(long*) (*(long*) icorRuntimeHostPtr2 + 16L))((IntPtr) icorRuntimeHostPtr2);
label_5:
    ...
    void* cookie)
  {
    ...
    try
    {
      ...
      // ISSUE: cast to a function pointer type
      // ISSUE: function pointer call
      int errorCode = __calli((__FnPtr<int (IntPtr, uint, __FnPtr<int (void*)>, void*)>) num1)((void*) iclrRuntimeHostPtr, (__FnPtr<int (void*)>) num2, (uint) local, (IntPtr) voidPtr);
      if (errorCode >= 0)
        return;
...
label_12:;
  ...
  [SuppressUnmanagedCodeSecurity]
  [MethodImpl(MethodImplOptions.Unmanaged | MethodImplOptions.PreserveSig, MethodCodeType = MethodCodeType.Native)]
  internal static extern unsafe int IsValidApp([In] int obj0, [In] void* obj1);

  [SuppressUnmanagedCodeSecurity]
  [MethodImpl(MethodImplOptions.Unmanaged | MethodImplOptions.PreserveSig, MethodCodeType = MethodCodeType.Native)]
  internal static extern unsafe int ModifyApp([In] int obj0, [In] void* obj1, [MarshalAs(UnmanagedType.U1)] bool _param2, [MarshalAs(UnmanagedType.U1)] bool _param3);

  [SuppressUnmanagedCodeSecurity]
  [MethodImpl(MethodImplOptions.Unmanaged | MethodImplOptions.PreserveSig, MethodCodeType = MethodCodeType.Native)]
  internal static extern void ChangePatchValues([In] long obj0, [In] long obj1, [In] long obj2, [In] long obj3);
  ...
  [SuppressUnmanagedCodeSecurity]
  [MethodImpl(MethodImplOptions.Unmanaged | MethodImplOptions.PreserveSig, MethodCodeType = MethodCodeType.Native)]
  internal static extern unsafe long TryFindValue([In] int* obj0);

  [SuppressUnmanagedCodeSecurity]
  [MethodImpl(MethodImplOptions.Unmanaged | MethodImplOptions.PreserveSig, MethodCodeType = MethodCodeType.Native)]
  internal static extern unsafe int SetDataSource([In] int obj0, [In] void* obj1, [In] int obj2);
  ...
  [SuppressUnmanagedCodeSecurity]
  [MethodImpl(MethodImplOptions.Unmanaged | MethodImplOptions.PreserveSig, MethodCodeType = MethodCodeType.Native)]
  internal static extern void IsBetaEditionTarget([MarshalAs(UnmanagedType.U1)] bool _param0);
